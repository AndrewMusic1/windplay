...
function preload() {
  ...
  soundArray[ 0 ] = loadSound("0-Synth2.wav");
  soundArray[ 1 ] = loadSound("1-Synth2.wav");
  soundArray[ 2 ] = loadSound("2-Synth2.wav");
  soundArray[ 3 ] = loadSound("3-Synth2.wav");
  soundArray[ 4 ] = loadSound("4-Synth2.wav");
  soundArray[ 5 ] = loadSound("5-Synth2.wav");
  soundArray[ 6 ] = loadSound("6-Synth2.wav");
  soundArray[ 7 ] = loadSound("7-Synth2.wav");
  soundArray[ 8 ] = loadSound("8-Synth2.wav");
  soundArray[ 9 ] = loadSound("9-Synth2.wav");
  soundArray[ 10 ] = loadSound("10-Synth2.wav");
  soundArray[ 11 ] = loadSound("11-Synth2.wav");


  backgroundImg1 = loadImage('Background.png')
  clefImg = loadImage('trebleClef.png');
  naturalImg = loadImage('Natural.png');
